      ...
      <table className="materials-table">
        <thead>
          <tr>
            <th>{t("table.name")}</th>
            <th>{t("table.type")}</th>
            <th>{t("table.sourceType")}</th>
            <th>{t("table.sourceLocation")}</th>
        ...
        <tbody>
          {materials.map((material) => (
            <tr key={material.id}>
              ...
              <td>{material.type}</td>
              <td>{material.sourceType ? t(`upload.sourceTypes.${material.sourceType}`) : t("table.sourceUpload")}</td>
              <td className="materials-source-location">{material.sourceLocation ?? material.filename}</td>
